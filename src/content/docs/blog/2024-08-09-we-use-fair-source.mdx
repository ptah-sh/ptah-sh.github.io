...
Hi! I'm Bohdan, the person behind ptah.sh. I want to tell you how I made ptah.sh and why I picked the <a href="https://fair.io/" target="_blank">Fair Source license</a> for it. It's a story that starts with a problem and ends with a solution that I hope can help others too.
...
- I'm **33 years old**.
- Born in Moldova, now living in Warsaw, Poland.
...
When I realized ptah.sh could help other people too, I had to think about how to share it. That's when I found out about the Fair Source license. Here's what it means:
...
Picking the Fair Source license was a big choice. Here's why I think it's good:
...
If you're using ptah.sh or thinking about it, here's what the Fair Source license means:
...
- **Yes, someone could copy the code**, but they'd be missing a lot:
  ...
  - The **legal right** to use the code (thanks to the Fair Source License)
...
## A Good Company
When I chose the Fair Source license for ptah.sh, I knew I was in good company. Sentry, a well-known error tracking platform, actually created this license. They wanted a way to share their code while still running a sustainable business. Since then, other respected tech companies have followed suit:
...
Seeing these successful companies use the Fair Source license showed me it's a solid choice for balancing openness with business needs. It's exciting to be part of this growing trend in the tech world!


## Looking Ahead

I think choosing the Fair Source license for ptah.sh might be part of a bigger change in how we share software. It's not just about picking between "free" or "paid" anymore. We're trying to find new ways to **share openly while still being able to keep working on our projects**.

## Wrapping Up

By using the Fair Source license for ptah.sh, I'm trying something new. I want to share my work but also build a business that can keep improving ptah.sh.

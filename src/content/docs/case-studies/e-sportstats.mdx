...
description: "Optimizing Costs and Performance with Ptah.sh"
---
...
As economic conditions shifted, the team began exploring ways to further optimize their costs without compromising performance. This led them to [Hetzner](https://dub.sh/ptah-sh-hetzner), which provided the powerful infrastructure they needed at a more competitive price point.
